...
export function DocumentsPage() {
  ...
  return (
    <div className="flex-1 glass-panel px-7 pt-[calc(6rem+env(safe-area-inset-top))] pb-[calc(2rem+env(safe-area-inset-bottom))] sm:p-8 bg-white/70 dark:bg-slate-900/40 lg:rounded-2xl rounded-none border-0 lg:border border-slate-200 dark:border-slate-800/50 lg:shadow-2xl max-lg:overflow-visible lg:overflow-y-auto w-full">
